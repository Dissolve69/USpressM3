...
#------------------ Basic Sentiment Analysis ------------------#
    ...
    return render(request, 'WebUSAtodaySentimentAnalysis.html', {'links': links, 'sortedwords': sortedwords, 'PositiveNum': PositiveNum, 'NegativeNum': NegativeNum, 'Totalwords':len(wordlist), 'PosorNeg': posNeg, 'positivewordslist':positivewordslist, 'negativewordslist':negativewordslist })
